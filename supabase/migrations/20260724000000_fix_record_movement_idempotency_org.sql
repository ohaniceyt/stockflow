-- Fix record_movement idempotency lookup to be scoped by org.
-- Without the org filter, the same client_operation_id reused across orgs would
-- return a movement from another organization and skip the real insert.
